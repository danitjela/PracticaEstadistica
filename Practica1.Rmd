...
`- ¿Hay más jugadores en juegos indies, en AA o AAA?`

`- ¿Tienen mejores críticas los indies, los AA o los AAA?`
...
`- ¿Depende la fecha de salida con el número de copias vendidas?`
...
ggplot(lab, aes(x = revenue)) +
  ...
  geom_histogram(binwidth = 2000000, fill = "blue", color = "black") +
...
Esta variable la estudiaremos para poder ver más adelante si se puede relacionar con la recaudación de los juegos. A continuación, con el siguiente código esudiaremos las frecuencias relativas y absolutas.
