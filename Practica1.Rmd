...
```{r}
  ...
  kable(tabla_contingencia_priceRevenue, caption = "y: beneficios (dólares) // x: precio (dólares)") |> 
...
```{r}
  ...
  kable(tabla_contingencia_priceRevenue2, caption = "y: beneficios (dólares) // x: precio (dólares)") |> 
  kable_styling(latex_options = c("striped", "hold_position"))
